...
#define EXT24V_RBOT_KOHM      0.5f
#define EXT24V_GAIN           ((EXT24V_RTOP_KOHM + EXT24V_RBOT_KOHM) / EXT24V_RBOT_KOHM)  // 10.5/0.5=21

#define BAT_RTOP_KOHM         100.0f
#define BAT_RBOT_KOHM         100.0f
...
// Thread-safe getters (true=유효값 반환)
